...
export default function ForecastsAndProjections({
  ...
  const calculateDateProgress = () => {
    ...
    const startDate = new Date(); // Assuming start date is today for simplicity
    startDate.setFullYear(startDate.getFullYear() - 1); // Assuming the goal was set 1 year ago
    ...
    <Card className="col-span-full">
      <CardHeader>
        ...
        <CardDescription>
          ...
          {forecastsAndProjections.currency})
        </CardDescription>
      </CardHeader>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs">
                        You&apos;re projected to reach your goal {daysRemaining}{" "}
